...
# goal conditioned bc
CUDA_VISIBLE_DEVICES=0 python quick_test_scripts/train_gcbcv2_pm.py -bs 1024 --max_steps 50000 --dataset_path maze2d-open-v0_osil_short_trajs/ --env_name maze2d-open-v0 --frac 1.0 -wb --run_name gcbcv2_maze2d_open_f1.0
CUDA_VISIBLE_DEVICES=0 python quick_test_scripts/train_gcbcv2_pm.py -bs 1024 --max_steps 50000 --dataset_path maze2d-open-v0_osil_short_trajs/ --env_name maze2d-open-v0 --frac 0.5 -wb --run_name gcbcv2_maze2d_open_f0.5
CUDA_VISIBLE_DEVICES=1 python quick_test_scripts/train_gcbcv2_pm.py -bs 1024 --max_steps 50000 --dataset_path maze2d-open-v0_osil_short_trajs/ --env_name maze2d-open-v0 --frac 0.25 -wb --run_name gcbcv2_maze2d_open_f0.25
CUDA_VISIBLE_DEVICES=1 python quick_test_scripts/train_gcbcv2_pm.py -bs 1024 --max_steps 50000 --dataset_path maze2d-open-v0_osil_short_trajs/ --env_name maze2d-open-v0 --frac 0.1 -wb --run_name gcbcv2_maze2d_open_f0.1
CUDA_VISIBLE_DEVICES=2 python quick_test_scripts/train_gcbcv2_pm.py -bs 1024 --max_steps 50000 --dataset_path maze2d-open-v0_osil_short_trajs/ --env_name maze2d-open-v0 --frac 0.05 -wb --run_name gcbcv2_maze2d_open_f0.05
CUDA_VISIBLE_DEVICES=2 python quick_test_scripts/train_gcbcv2_pm.py -bs 1024 --max_steps 50000 --dataset_path maze2d-open-v0_osil_short_trajs/ --env_name maze2d-open-v0 --frac 0.01 -wb --run_name gcbcv2_maze2d_open_f0.01
