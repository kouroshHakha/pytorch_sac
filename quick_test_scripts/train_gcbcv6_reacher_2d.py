"""
This version modularizes the agent into an eef predictor and an eef -> torque predictor
"""
import time
import warnings
import numpy as np
...
def main(pargs):
    ...
    #     ParamDict(max_eval_episodes=1, env_name='Reacher2D-v1', max_render=1, is_image=pargs.image),
    #     train_dataset, output_dir='test_gcbcv6_render', mode='train'
    # )
