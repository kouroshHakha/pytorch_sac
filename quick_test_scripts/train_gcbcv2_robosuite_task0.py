...
class GCBCDataset(Dataset):
    ...
    def __init__(
        ...
        self.allowed_ids = [class_to_task_map[i] for i in self.splits['train']]
        ...
        for task_id, var_id in self.allowed_ids:
            ...
            for ep in episodes[slice_map[mode]]:
                ...
                elif env_name.startswith('robosuite'):
...
class EvaluatorPickPlace(EvaluatorPickPlaceSawyer):
    ...
    def get_test_cases(self, test_dataset):
        ...
        for task_id, var_id in test_task_ids:
            ...
            episodes = test_dataset.raw_data[task_id][var_id][slice_map[self.mode]]
...
def main(pargs):
    ...
    if train:
        ...
        print(f'Evaluating with {trainer.checkpoint_callback.best_model_path} ...')
